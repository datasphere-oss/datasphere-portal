...
public interface UserInf {
     ...
     */
    void setLabels(List<SecurityLabelInf> labels);
    /**
     * Get user token.
     *
     * @return user token.
