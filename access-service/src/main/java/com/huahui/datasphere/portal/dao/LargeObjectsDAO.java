...
import com.huahui.datasphere.portal.po.lob.LargeObject;
...
public interface LargeObjectsDAO {
     ...
     */
    LargeObject loadLargeObject(UUID id, boolean isBinary);
    /**
     * Upsert large object.
     ...
     * @throws IOException
     */
    boolean upsertLargeObject(LargeObject lob) throws IOException;
    /**
     * Sets a record active (submits an attachment).
     * @param spec activation spec (objects)
     * @return true if successful, false otherwise
     */
    boolean submitLargeObjects(Collection<LargeObject> spec);
    /**
