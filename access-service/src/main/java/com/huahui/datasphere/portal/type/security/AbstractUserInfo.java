 ...
 */
public abstract class AbstractUserInfo implements UserInf, Serializable {
    /**
     * SVUID.
     */
     ...
     * Labels list.
     */
    private List<SecurityLabelInf> labels;
    /**
     * Custom properties.
     */
     ...
     */
    @Override
    public List<SecurityLabelInf> getLabels() {
     ...
     */
    @Override
    public void setLabels(List<SecurityLabelInf> labels) {
        this.labels = labels;
    }
    /**
