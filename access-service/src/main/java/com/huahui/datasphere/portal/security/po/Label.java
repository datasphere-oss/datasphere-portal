...
public class Label extends BaseSecurity implements Serializable {
    ...
    /** The label attribute. */
    // bi-directional many-to-one association to LabelAttribute
    private final List<LabelAttribute> labelAttribute = new ArrayList<>();
     ...
     */
    public List<LabelAttribute> getLabelAttribute() {
     ...
     */
    public void setLabelAttribute(List<LabelAttribute> labelAttribute) {
     ...
     */
    public LabelAttribute addLabelAttribute(LabelAttribute labelAttribute) {
     ...
     * @return the label attribute po
     */
    public LabelAttribute removeLabelAttribute(LabelAttribute labelAttribute) {
