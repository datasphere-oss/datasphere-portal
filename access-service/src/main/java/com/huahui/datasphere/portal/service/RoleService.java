...
package com.huahui.datasphere.portal.service;
...
public interface RoleService {
     ...
     */
    List<SecurityLabelInf> getAllSecurityLabels();
     ...
     *            the role dto
     */
    void update(String roleName, RoleInf role);
     ...
     *            the label
     */
    void createLabel(SecurityLabelInf label);
     ...
     *            the label name
     */
    void updateLabel(SecurityLabelInf label, String labelName);
     ...
     */
    SecurityLabelInf findLabel(String labelName);
    ...
    List<RoleInf> loadRolesData(List<String> rolesName);
