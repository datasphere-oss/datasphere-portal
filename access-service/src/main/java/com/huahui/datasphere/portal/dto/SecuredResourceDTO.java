 ...
 * @author ilya.bykov
 */
public class SecuredResourceDTO extends BaseSecurityDTO implements SecuredResourceInf, Serializable {
     ...
     */
    public SecuredResourceDTO(SecuredResourceInf other) {
        super();
     ...
     */
    public void setType(SecuredResourceTypeInf type) {
        this.type = type;
    }
