...
public class SecurityToken implements Serializable {
     ...
     */
    private EndpointTypeInf endpoint;
    /**
     * IP, audit related.
     */
     ...
     * User rights map.
     */
    private final Map<String, RightInf> rightsMap = new HashMap<>();
    /**
     * Roles map.
     */
     ...
     */
    private final Map<String, List<SecurityLabelInf>> labelsMap = new HashMap<>();
    /**
     * inner
     */
     ...
     */
    public Map<String, RightInf> getRightsMap() {
        return rightsMap;
    }
     ...
     */
    public Map<String, List<SecurityLabelInf>> getLabelsMap() {
        return labelsMap;
    }

    public EndpointTypeInf getEndpoint() {
        return endpoint;
    }

    public void setEndpoint(EndpointTypeInf endpoint) {
