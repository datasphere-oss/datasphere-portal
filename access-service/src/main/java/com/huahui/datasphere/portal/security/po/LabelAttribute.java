 ...
 *
 */
public class LabelAttribute extends BaseSecurity implements Serializable {
    ...
    // bi-directional many-to-one association to LabelAttributeValue
    ...
    public LabelAttribute(final Integer id, final String name, final String path, final String description) {
        this.id = id;
        this.name = name;
        this.path = path;
    ...
    public LabelAttribute(Integer id) {
        this.id = id;
    }
    /**
     * Gets the id.
     ...
     */
    public void setLabelAttributeValues(Collection<LabelAttributeValue> labelAttributeValues) {
     ...
     */
    public LabelAttribute addLabelAttributeValue(LabelAttributeValue labelAttributeValue) {
     ...
     * @return the label attribute value po
     */
    public LabelAttributeValue removeLabelAttribute(LabelAttributeValue labelAttributeValue) {
